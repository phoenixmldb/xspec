...
### FORX0002: Invalid regular expression: POSIX character class syntax '[:' is not s… (3 suites)
...
### startIndex cannot be larger than length of string. (Parameter 'startIndex') (1 suite)
...
- Stage: Compile
- Error code: XTTE0780
- Error: XTTE0780: Function resolve-import return value requires type Node but got String
