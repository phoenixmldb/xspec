...
### FORX0002: Invalid regular expression: POSIX character class syntax '[:' is not s… (5 suites)
...
### startIndex cannot be larger than length of string. (Parameter 'startIndex') (2 suites)
...
- Stage: Compile
- Error code: XPTY0004
- Error: fn:QName second argument must be a string, got XsTypedString
