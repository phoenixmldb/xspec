...
Of the 80 suites that ran to completion: 244 tests passed, 311 failed, 0 pending, out of 555 total. This excludes 122 skipped and 82 suites that did not reach completion — see below for both.
...
### Named template 'context-mirror' not found (8 suites)

- `/repos/phoenixml/xspec/test/external_as_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_context-param.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_xml-base_stylesheet.xspec` (stage: Run)
...
### Named template 'param-mirror' not found (4 suites)

- `/repos/phoenixml/xspec/test/external_avt-ws_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_no-prefix_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_node-selection_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_use-uqname_stylesheet.xspec` (stage: Run)
...
### Named template 'tunnel-param-mirror' not found (1 suite)
...
### XPST0003: mismatched input ']' expecting {'for', 'let', 'where', 'order', 'by', … (1 suite)
...
- Stage: Run
- Error: Named template 'context-mirror' not found

### `/repos/phoenixml/xspec/test/external_avt-ws_stylesheet.xspec`

- Stage: Run
- Error: Named template 'param-mirror' not found
...
- Stage: Run
- Error: Named template 'tunnel-param-mirror' not found
...
- Stage: Run
- Error code: XPST0008
- Error: Variable $Q{urn:x-xspec:compile:impl}param-d15ead73 not bound

### `/repos/phoenixml/xspec/test/external_tvt_stylesheet.xspec`

- Stage: Run
- Error code: XPST0008
- Error: Variable $Q{urn:x-xspec:compile:impl}param-d26b32e5 not bound

### `/repos/phoenixml/xspec/test/external_undeclare-ns_stylesheet.xspec`

- Stage: Run
- Error code: XPTY0004
- Error: [file:///repos/phoenixml/xspec/test/external_undeclare-ns_stylesheet.xspec:7:11888] fn:in-scope-prefixes() requires an element node, got empty sequence
...
- Stage: Run
- Error code: FOTY0013
- Error: [file:///repos/phoenixml/xspec/test/non-node-context.xspec:4] [file:///tmp/phxspec-src-f0aae326d6474980913772d2171934b7/common/deep-equal.xsl:64] [file:///tmp/phxspec-src-f0aae326d6474980913772d2171934b7/common/deep-equal.xsl:158] Atomization is not defined for maps
  ...
  ↳ in expression (BinaryExpression): (not($result-type-mismatch) and deep-equal($expect-d2dbb6e4, $result, ""))
