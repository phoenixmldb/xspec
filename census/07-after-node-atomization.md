...
- `/repos/phoenixml/xspec/test/compiler-misc-utils.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/compiler-pending-utils.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/compiler-sequencetype-with-uqnames.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/declare-variable.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/default-mode-parent-runas-imported.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/issue-215.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-23_1.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-26.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-30.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-33.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-46.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/issue-638.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-700.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-777_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-826.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-987_child.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-987_parent.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/namespace-vars.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/nested-context.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/nested-template-call.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/trim.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/tutorial_global-context-item_testable.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/tutorial_helper_ws-only-text_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/tutorial_under-the-hood_compilation-sut_template.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/xslt1.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/xslt3.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/xslt4.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/yes-no-utils.xspec` (stage: Run)
...
### FORX0002: Invalid regular expression: POSIX character class syntax '[:' is not s… (10 suites)
...
- Stage: Run
- Error code: XTSE0010
- Error: XTSE0010: The 'version' attribute is required on xsl:stylesheet/xsl:transform
