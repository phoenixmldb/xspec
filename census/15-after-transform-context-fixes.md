...
Of the 86 suites that ran to completion: 257 tests passed, 339 failed, 0 pending, out of 596 total. This excludes 122 skipped and 76 suites that did not reach completion — see below for both.

## Pick-list (by error code)

### XPST0008 (15 suites)

- `/repos/phoenixml/xspec/test/avt-ws_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_avt-ws_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_avt_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_global-context_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_pending-scenario-param-inherited-by-focus.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_pending-scenario-shared-param-inherited-by-focus.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_tutorial_under-the-hood_compilation-params-scope.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_tvt-ws_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_tvt_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_unfocused-param_inherited-by-focus.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_unfocused-shared-param_inherited-by-focus.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/tvt-ws_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/uqname-utils.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/variable-like_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/variable_stylesheet.xspec` (stage: Run)

### XPDY0050 (6 suites)

- `/repos/phoenixml/xspec/test/catch_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/compile-xproc-tests.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_catch_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/generate-pipeline.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/generate-test-case-step-catch.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/generate-test-case-step.xspec` (stage: Run)

### XPTY0004 (5 suites)

- `/repos/phoenixml/xspec/test/external_template-context.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_undeclare-ns_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/wrap_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/xspec-name.xspec` (stage: Run)

### XTDE3052 (5 suites)

- `/repos/phoenixml/xspec/test/external_xslt-package_arith_use-1.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_xslt-package_arith_use-2.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_xslt-package_filter_use.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_xslt-package_filter_use_static-param.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/helper_xslt-package.xspec` (stage: Run)

### FOTY0013 (4 suites)

- `/repos/phoenixml/xspec/test/external_non-node-context.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_xslt-package_arith.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_xslt-package_arith_private.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/non-node-context.xspec` (stage: Run)
...
### XPST0003: mismatched input '<EOF>' expecting {'for', 'let', 'where', 'order', 'b… (3 suites)
...
- `/repos/phoenixml/xspec/test/global-override.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/xmlns_stylesheet.xspec` (stage: Compile)

### XTTE0570 (3 suites)

- `/repos/phoenixml/xspec/test/report-sequence_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/selection-from-doc-xproc.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/test-utils.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_multiple-context-items_function.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-59_stylesheet.xspec` (stage: Run)

### XPST0003: mismatched input ']' expecting {'for', 'let', 'where', 'order', 'by', … (2 suites)

- `/repos/phoenixml/xspec/test/external_issue-1564_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_multiple-context-items.xspec` (stage: Run)

### XPST0003: token recognition error at: '&' (2 suites)

- `/repos/phoenixml/xspec/test/external_x-context.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/x-context.xspec` (stage: Run)

### XPTY0020 (2 suites)

- `/repos/phoenixml/xspec/test/external_nested-function-call.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_ws-only-text_stylesheet.xspec` (stage: Run)

### XQuery parse failed with 2 errors: XPST0003: token recognition error at: '&' (2 suites)

- `/repos/phoenixml/xspec/test/external_issue-1020_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/issue-1020_stylesheet.xspec` (stage: Run)

### XTDE0430 (2 suites)

- `/repos/phoenixml/xspec/test/external_coverage-contents-table.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/tutorial_namespaces_stylesheet.xspec` (stage: Compile)

### Could not find file '/repos/phoenixml/xspec/test/generate-node-selector.xsl'. (1 suite)

- `/repos/phoenixml/xspec/test/select-node.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/xslt4.xspec` (stage: Run)

### Required parameter $cols not supplied (1 suite)

- `/repos/phoenixml/xspec/test/external_nested-template-call.xspec` (stage: Run)

### Required parameter $f not supplied (1 suite)

- `/repos/phoenixml/xspec/test/external_xslt4.xspec` (stage: Run)

### Required parameter $param-items not supplied (1 suite)

- `/repos/phoenixml/xspec/test/external_prefix-conflict_stylesheet.xspec` (stage: Run)

### Required parameter $tunnel-param-items not supplied (1 suite)

- `/repos/phoenixml/xspec/test/external_tunnel-param.xspec` (stage: Run)

### Transformation terminated: ERROR in x:expect ('Scenario for testing variable sax… (1 suite)
...
- `/repos/phoenixml/xspec/test/external_xsl-result-document_has-href.xspec` (stage: Run)

### XTSE0150 (1 suite)

- `/repos/phoenixml/xspec/test/issue-746.xspec` (stage: Run)

### XTSE0165 (1 suite)

- `/repos/phoenixml/xspec/test/issue-1135.xspec` (stage: Run)
...
- Stage: Run
- Error code: XPST0008
- Error: Variable $myv:function-calls-with-ws not bound
...
- Passed: 0, Failed: 16, Pending: 0
  ...
  - FAIL: In context template-param, only user-content attribute is AVT. So... / In //x:context/x:param/doc(@href), / attribute is intact.
  - FAIL: In context template-param, only user-content attribute is AVT. So... / In //x:context/x:param/doc(@href), / text node is intact.
  ...
  - FAIL: In context, only user-content attribute is AVT. So... / In //x:context/doc(@href), / attribute is intact.
  - FAIL: In context, only user-content attribute is AVT. So... / In //x:context/doc(@href), / text node is intact.
  ...
  - FAIL: In template-call template-param, only user-content attribute is AVT. So... / In //x:call[@template]/x:param/doc(@href), / attribute is intact.
  - FAIL: In template-call template-param, only user-content attribute is AVT. So... / In //x:call[@template]/x:param/doc(@href), / text node is intact.
  - FAIL: In global-param, only user-content attribute is AVT. So... / In /x:description/x:param/node(), / attribute is AVT.
  - FAIL: In global-param, only user-content attribute is AVT. So... / In /x:description/x:param/node(), / text node is intact.
  - FAIL: In global-param, only user-content attribute is AVT. So... / In /x:description/x:param/doc(@href), / attribute is intact.
  - FAIL: In global-param, only user-content attribute is AVT. So... / In /x:description/x:param/doc(@href), / text node is intact.
...
- Stage: Run
- Error code: XPDY0050
- Error: The context item for '/' is not in a tree rooted at a document node

### `/repos/phoenixml/xspec/test/compile-xslt-tests.xspec`

- Stage: Complete
- Passed: 0, Failed: 5, Pending: 0
  - FAIL: x:scenario[@label] transformed in x:compile-scenario template / 
            - is xsl:template
  ...
  - FAIL: x:expect[@test] transformed in x:compile-expect template / is a pair of templates
  - FAIL: x:expect[@test] transformed in x:compile-expect template / @test must be transformed to calls to *-predicate template
  - FAIL: x:expect[@test] transformed in x:compile-expect template / @test must also produce a template named *-predicate for evaluating @test
  - FAIL: x:expect[@test] transformed in x:compile-expect template / @result-type must be transformed to result-type-mismatch variable

### `/repos/phoenixml/xspec/test/compiler-eqname-utils.xspec`

- Stage: Complete
- Passed: 7, Failed: 11, Pending: 0
  - FAIL: Scenario for testing function QName-expression-from-EQName-ignoring-default-ns / URIQualifiedName / With URI / Converted with apostrophe escaped
  - FAIL: Scenario for testing function QName-expression-from-EQName-ignoring-default-ns / URIQualifiedName / Without URI / Converted without being affected by the default namespace
  - FAIL: Scenario for testing function QName-expression-from-EQName-ignoring-default-ns / Lexical QName / With prefix / Converted
  - FAIL: Scenario for testing function QName-expression-from-EQName-ignoring-default-ns / Lexical QName / Without prefix / With default namespace / Converted without using the default namespace
  - FAIL: Scenario for testing function QName-expression-from-EQName-ignoring-default-ns / Lexical QName / Without prefix / Without default namespace / Converted
  - FAIL: Scenario for testing function UQName-from-EQName-ignoring-default-ns / URIQualifiedName / With URI / Intact
  - FAIL: Scenario for testing function UQName-from-EQName-ignoring-default-ns / URIQualifiedName / Without URI / Intact
  - FAIL: Scenario for testing function UQName-from-EQName-ignoring-default-ns / Lexical QName / With prefix / Resolved with prefix
  - FAIL: Scenario for testing function UQName-from-EQName-ignoring-default-ns / Lexical QName / Without prefix / With default namespace / Resolved without using the default namespace
  - FAIL: Scenario for testing function UQName-from-EQName-ignoring-default-ns / Lexical QName / Without prefix / Without default namespace / Resolved as no prefix
  - FAIL: Scenario for testing variable capture-NCName / Captured

### `/repos/phoenixml/xspec/test/compiler-misc-utils.xspec`

- Stage: Complete
- Passed: 5, Failed: 5, Pending: 0
  - FAIL: Scenario for testing function xslt-version / default
  - FAIL: Scenario for testing function xslt-version / defined in self
  - FAIL: Scenario for testing function xslt-version / defined in parent
  - FAIL: Scenario for testing function xslt-version / defined in grandparent
  - FAIL: Scenario for testing function xslt-version / override

### `/repos/phoenixml/xspec/test/compiler-pending-utils.xspec`

- Stage: Complete
- Passed: 0, Failed: 25, Pending: 0
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenarios that use @pending and nest / Prior to any pending markup, accumulator is an empty sequence
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenarios that use @pending and nest / Prior to start of Pending #1 scenario, accumulator is still an empty sequence
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenarios that use @pending and nest / At start of Pending #1 scenario, accumulator has first pending reason
  ...
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenarios that use @pending and nest / At end of Pending #1 scenario, accumulator is an empty sequence
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenario that uses x:pending[@label] / At start of x:pending[@label], accumulator has pending reason
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenario that uses x:pending[@label] / At start of scenario inside x:pending[@label], accumulator still has pending reason
  ...
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenario that uses x:pending[@label] / At end of x:pending[@label], accumulator no longer has pending reason
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenario that uses x:pending[x:label] / At start of x:pending[x:label], accumulator has pending reason
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenario that uses x:pending[x:label] / At start of scenario inside x:pending[x:label], accumulator has pending reason
  ...
  - FAIL: Tests for 'stacked-explicit-pending' accumulator / Pending scenario that uses x:pending[x:label] / At end of x:pending[x:label], accumulator no longer has pending reason
  - FAIL: Tests for x:reason-for-pending function / No focus or pending / Empty sequence
  - FAIL: Tests for x:reason-for-pending function / @focus on ancestor scenario / Empty sequence, because ancestor's @focus overrides pending reason
  - FAIL: Tests for x:reason-for-pending function / Parameter located in pending scenario and inherited by scenario with @focus / Empty sequence, because inheritance overrides pending reason
  - FAIL: Tests for x:reason-for-pending function / Variable located in pending scenario and inherited by scenario with @focus / Empty sequence, because inheritance overrides pending reason
  - FAIL: Tests for x:reason-for-pending function / @focus elsewhere makes a scenario pending (implicit reason) / Reason from first @focus
  - FAIL: Tests for x:reason-for-pending function / @focus irrelevant for element outside scenarios / Empty sequence, because @focus does not make this context pending
  - FAIL: Tests for x:reason-for-pending function / @focus and @pending both affect context,  / where pending scenario is before focused scenario / @pending reason is preferred
  - FAIL: Tests for x:reason-for-pending function / @focus and @pending both affect context,  / where pending scenario is after focused scenario / @pending reason is preferred
  - FAIL: Tests for x:reason-for-pending function / @focus and @pending both affect context,  / where child of scenario[@pending] is deeper than focused scenario / @pending reason is preferred
...
- Stage: Complete
- Passed: 0, Failed: 12, Pending: 0
  - FAIL: Lexical QName in @as attribute / as the entire @as value / Declaring namespace on the context element / enables correct conversion to UQName
  - FAIL: Lexical QName in @as attribute / as the entire @as value / Declaring namespace on ancestor of context element / enables correct conversion to UQName
  - FAIL: Lexical QName in @as attribute / as the entire @as value / When prefix is declared differently on ancestor of context element / conversion to UQName uses nearest binding
  - FAIL: Lexical QName in @as attribute / in parentheses / as the only argument / is converted to UQName
  - FAIL: Lexical QName in @as attribute / in parentheses / as first argument, with UQName following / is converted to UQName, and UQName is preserved
  - FAIL: Lexical QName in @as attribute / in parentheses / as second argument, with UQName preceding / is converted to UQName, and UQName is preserved
  - FAIL: Lexical QName in @as attribute / in parentheses / in both arguments / are both converted to UQName
  - FAIL: Lexical QName in @as attribute / in parentheses / in both arguments, with line break, / are both converted to UQName, with same whitespace
  - FAIL: Lexical QName in @as attribute / in parentheses / When URIs include characters that look like delimiters (parentheses, comma) / the analysis of lexical QNames and UQNames is still correct
  - FAIL: Lexical QName in @as attribute / in parentheses / When prefix is implicitly known instead of explicitly declared / conversion to UQName uses implicit definition
  - FAIL: Edge cases / @as value has no lexical QName / has no change (and xmlns:a is irrelevant because a:b is a URI here, not a lexical QName)
...
- Passed: 5, Failed: 1, Pending: 0
  - FAIL: When x:context has @href document containing x:param, / x:param in @href document does not work as a parameter. So... / Templates receive no parameter.

### `/repos/phoenixml/xspec/test/declare-variable.xspec`

- Stage: Complete
- Passed: 1, Failed: 1, Pending: 0
  - FAIL: Scenario for testing function variable-UQName / With @name / URIQualifiedName with namespace and local name specified in @name
...
- Stage: Complete
- Passed: 7, Failed: 3, Pending: 0
  - FAIL: In context template-param (i.e. //x:context/x:param), when @as uses a prefix defined in x:param, / @as takes effect
  - FAIL: In function-param (i.e. //x:call[@function]/x:param), / when the function has multiple params and all @as share the same prefix but each prefix has different URI defined in x:param, / @as doesn't break the params
  - FAIL: In template-call template-param (i.e. //x:call[@template]/x:param), when @as uses a prefix defined in x:param, / @as takes effect
...
- Stage: Run
- Error code: XPST0008
- Error: Variable $scenario-param-no-href not bound
...
- Stage: Complete
- Passed: 0, Failed: 6, Pending: 0
  - FAIL: When x:context has x:param and another child node, / setting up the context excludes x:param from the context nodes. So... / When a template is called, / Only the non x:param nodes remain in the context nodes.
  ...
  - FAIL: When x:context has x:param and another child node, / setting up the context does not affect the template parameters. So... / x:param works as a parameter.
  ...
  - FAIL: When x:context has @href document containing x:param, / setting up the context does not affect @href document. So... / When templates are applied, / The document is kept intact.
  - FAIL: When x:context has @href document containing x:param, / x:param in @href document does not work as a parameter. So... / Templates receive no parameter.
...
- Stage: Compile
- Error code: XTDE0430
- Error: XTDE0430: Two namespace nodes with the same prefix '' have different namespace URIs ('' and 'http://www.w3.org/1999/xhtml')

### `/repos/phoenixml/xspec/test/external_default-mode-included-runas.xspec`

- Stage: Complete
- Passed: 0, Failed: 3, Pending: 0
  - FAIL: x:context[not(@mode)] / Uses xsl:template[not(@mode)]. transform() uses XSLT @default-mode as initial mode.
  - FAIL: x:context/@mode='implicit-default-mode' / Uses xsl:template[not(@mode)], to which XSLT @default-mode applies. XSpec passes x:context/@mode to transform() as initial mode.
  - FAIL: x:call by name, to template with mode='#unnamed' / A way to reach xsl:template[@mode='#unnamed'] despite transform() using XSLT @default-mode as initial mode.

### `/repos/phoenixml/xspec/test/external_default-mode-parent.xspec`

- Stage: Complete
- Passed: 0, Failed: 3, Pending: 0
  - FAIL: x:context[not(@mode)] / Uses xsl:template[@mode='#unnamed']. Parent XSLT has no @default-mode, so transform() defaults to unnamed mode.
  - FAIL: x:context/@mode='implicit-default-mode' / Uses xsl:template[not(@mode)], to which XSLT @default-mode applies. XSpec passes x:context/@mode to transform() as initial mode.
  - FAIL: x:call by name, to template with mode='#unnamed' / Alternate way to reach xsl:template[@mode='#unnamed']
...
- Stage: Run
- Error code: XPST0008
- Error: XPST0008: Variable $context-variable not defined

### `/repos/phoenixml/xspec/test/external_global-override.xspec`

- Stage: Complete
- Passed: 0, Failed: 18, Pending: 0
  - FAIL: With scenario-level x:param and / global xsl:param, / x:param should always override xsl:param
  - FAIL: With scenario-level x:param and / global xsl:variable, / scenario-level x:param should never override xsl:variable
  - FAIL: With scenario-level x:param and / no corresponding xsl:param, / the declared param takes effect only in XSpec
  - FAIL: With empty scenario-level x:param and / global xsl:param, / x:param should always override xsl:param
  - FAIL: With empty scenario-level x:param and / global xsl:variable, / scenario-level x:param should never override xsl:variable
  - FAIL: With global x:param and / global xsl:param, / x:param should always override xsl:param
  - FAIL: With global x:param and / global xsl:variable, / x:param should override xsl:variable unless run-as=external
  - FAIL: With global x:param and / no corresponding xsl:param, / the declared param takes effect only in XSpec
  - FAIL: With empty global x:param and / global xsl:param, / x:param should always override xsl:param
  - FAIL: With empty global x:param and / global xsl:variable, / x:param should override xsl:variable unless run-as=external
  - FAIL: With global x:variable and / global xsl:param, / run-as=import allows x:variable to override xsl:param, although not an
					official recommended usage of x:variable. run-as=external should never allow
					it.
  - FAIL: With global x:variable and / global xsl:variable, / run-as=import allows x:variable to override xsl:variable, although not an
					official recommended usage of x:variable. run-as=external should never allow
					it.
  - FAIL: With empty global x:variable and / global xsl:param, / run-as=import allows x:variable to override xsl:param, although not an
					official recommended usage of x:variable. run-as=external should never allow
					it.
  - FAIL: With empty global x:variable and / global xsl:variable, / run-as=import allows x:variable to override xsl:variable, although not an
					official recommended usage of x:variable. run-as=external should never allow
					it.
  - FAIL: With scenario-level x:variable and / global xsl:param, / scenario-level x:variable should never override xsl:param
  - FAIL: With scenario-level x:variable and / global xsl:variable, / scenario-level x:variable should never override xsl:variable
  - FAIL: With empty scenario-level x:variable and / global xsl:param, / scenario-level x:variable should never override xsl:param
  - FAIL: With empty scenario-level x:variable and / global xsl:variable, / scenario-level x:variable should never override xsl:variable
...
- Stage: Run
- Error: XQuery parse failed with 2 errors: XPST0003: token recognition error at: '&'

### `/repos/phoenixml/xspec/test/external_issue-1564.xspec`

- Stage: Complete
- Passed: 0, Failed: 1, Pending: 0
  - FAIL: x:call/x:param[@function]/@name / should not affect global variable (XQuery) or global parameter (XSLT)

### `/repos/phoenixml/xspec/test/external_issue-1564_stylesheet.xspec`

- Stage: Run
- Error: XPST0003: mismatched input ']' expecting {'for', 'let', 'where', 'order', 'by', 'return', 'in', 'allowing', 'empty', 'at', 'stable', 'ascending', 'descending', 'greatest', 'least', 'collation', 'group', 'count', 'while', 'member', 'record', 'enum', 'tumbling', 'sliding', 'window', 'start', 'end', 'when', 'only', 'previous', 'next', 'current', 'if', 'then', 'else', 'some', 'every', 'satisfies', 'switch', 'case', KW_DEFAULT, 'typeswitch', 'try', 'catch', 'and', 'or', 'not', 'eq', 'ne', 'lt', 'le', 'gt', 'ge', 'is', 'div', 'idiv', 'mod', 'instance', 'of', 'treat', 'as', 'castable', 'cast', 'to', 'union', 'intersect', 'except', 'otherwise', 'insert', 'delete', 'replace', 'rename', 'copy', 'modify', 'into', 'with', 'nodes', 'value', 'before', 'after', 'first', 'last', 'contains', 'ftand', 'ftor', 'ftnot', 'phrase', 'any', 'all', 'word', 'words', 'distance', 'same', 'sentence', 'paragraph', 'entire', 'content', 'stemming', 'language', 'wildcards', 'sensitive', 'insensitive', 'diacritics', 'stop', 'thesaurus', 'using', 'no', 'item', 'node', 'element', 'attribute', 'text', 'comment', 'document-node', 'processing-instruction', 'schema-element', 'schema-attribute', 'namespace-node', 'empty-sequence', 'function', 'fn', 'child', 'descendant', 'self', 'descendant-or-self', 'following-sibling', 'following', 'parent', 'ancestor', 'preceding-sibling', 'preceding', 'ancestor-or-self', 'namespace', 'document', 'map', 'array', 'xquery', 'version', 'encoding', 'module', 'declare', 'variable', 'import', 'schema', 'external', 'option', 'construction', 'ordering', 'ordered', 'unordered', 'preserve', 'strip', 'boundary-space', 'copy-namespaces', 'no-preserve', 'inherit', 'no-inherit', 'base-uri', 'decimal-format', 'context', 'validate', 'strict', 'lax', 'type', '(', '[', LBRACE, '.', '..', '/', '//', '$', LESS_THAN, '+', '-', '*', '?', '(#', '%', '->', '@', IntegerLiteral, DecimalLiteral, DoubleLiteral, StringLiteral, URIQualifiedName, BracedURILiteral, NCName, DIR_PI_CONSTRUCTOR, DIR_COMMENT_CONSTRUCTOR, '``['}
...
- Stage: Run
- Error code: XPDY0002
- Error: XPDY0002: Context item is absent

### `/repos/phoenixml/xspec/test/external_nested-context.xspec`

- Stage: Complete
- Passed: 0, Failed: 3, Pending: 0
  - FAIL: when an element containing an attribute and a text is transformed / in 'upper-case-text' mode / the text should be upper-cased
  - FAIL: when an element containing an attribute and a text is transformed / in 'upper-case-attribute' mode / the attribute value should be upper-cased
  - FAIL: when an element containing an attribute and a text is transformed / in 'upper-case-attribute' mode / in 'upper-case-text' mode (override an ancestor mode) / the text should be upper-cased

### `/repos/phoenixml/xspec/test/external_nested-function-call.xspec`

- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_nested-function-call.xspec:7:15957] An axis step (Child::table) was used when the context item is not a node (got item of type CrossStoreNodeRef)

### `/repos/phoenixml/xspec/test/external_nested-template-call.xspec`

- Stage: Run
- Error: Required parameter $cols not supplied

### `/repos/phoenixml/xspec/test/external_no-prefix_stylesheet.xspec`

- Stage: Complete
- Passed: 0, Failed: 4, Pending: 0
  - FAIL: Using URIQualifiedName in scenario-level global-param (@as | @name | @select) / should be possible
  - FAIL: Using URIQualifiedName in / context @mode and context template-param (@as | @name | @select) / should be possible
...
- Stage: Complete
- Passed: 4, Failed: 7, Pending: 0
  - FAIL: In context template-param, @href precedes child node. So... / In //x:context/x:param[node()][not(@href)], / child node is used.
  - FAIL: In context template-param, @href precedes child node. So... / In //x:context/x:param[node()][@href], / @href is used.
  - FAIL: In context, @href precedes child node. / So... / In //x:context[node()][not(@href)], / child node is used.
  - FAIL: In context, @href precedes child node. / But child x:param shouldn't be affected. So... In //x:context[x:param][@href], both x:param and @href are used; / therefore / @href is used.
  - FAIL: In context, @href precedes child node. / But child x:param shouldn't be affected. So... In //x:context[x:param][@href], both x:param and @href are used; / therefore / x:param is used.
  - FAIL: In template-call template-param, @href precedes child node. So... / In //x:call[@template]/x:param[node()][not(@href)], / child node is used.
  - FAIL: In template-call template-param, @href precedes child node. So... / In //x:call[@template]/x:param[node()][@href], / @href is used.

### `/repos/phoenixml/xspec/test/external_non-node-context.xspec`

- Stage: Run
- Error code: FOTY0013
- Error: [file:///repos/phoenixml/xspec/test/external_non-node-context.xspec:4] [file:///tmp/phxspec-src-6432bf425b804560b4dc510967b6a04d/common/deep-equal.xsl:64] [file:///tmp/phxspec-src-6432bf425b804560b4dc510967b6a04d/common/deep-equal.xsl:158] Atomization is not defined for maps
  ↳ in expression (FunctionCallExpression): deep-equal($item1, $item2)
  ↳ in expression (QuantifiedExpression): every $i in (1 to count($seq1)) satisfies deq:item-deep-equal($seq1[$i], $seq2[$i], $flags)
  ↳ in expression (BinaryExpression): (not($result-type-mismatch) and deep-equal($expect-d30d135c, $result, ""))

### `/repos/phoenixml/xspec/test/external_param-position.xspec`

- Stage: Complete
- Passed: 0, Failed: 4, Pending: 0
  - FAIL: When all instances of function-param have @position in ascending order / The parameters are picked up in @position order
  - FAIL: When all instances of function-param have @position in descending order / The parameters are picked up in @position order
  - FAIL: When multiple instances of function-param @position are not consecutive / The parameters are picked up in relative @position order
  - FAIL: When parameters are nested / 4 (greater than count(ancestor-or-self::x:scenario/x:call/x:param)) / implicit 1 (overrides a grandparent parameter) and implicit 2 (inserted in the midst) / 3 (inserted in the midst) and 4 (overrides a grandparent parameter) / expect / The parameters are merged

### `/repos/phoenixml/xspec/test/external_pending-scenario-param-inherited-by-focus.xspec`

- Stage: Run
- Error code: XPST0008
- Error: XPST0008: Variable $scenario-param-under-x-pending not defined

### `/repos/phoenixml/xspec/test/external_pending-scenario-shared-param-inherited-by-focus.xspec`

- Stage: Run
- Error code: XPST0008
- Error: XPST0008: Variable $scenario-param-under-x-pending-or-pending-attribute not defined

### `/repos/phoenixml/xspec/test/external_prefix-conflict_stylesheet.xspec`

- Stage: Run
- Error: Required parameter $param-items not supplied
...
- Stage: Complete
- Passed: 0, Failed: 6, Pending: 0
  - FAIL: Destination templates have @use-when depending on static parameter values / Description-level static param $A and / non-overridden static param $B / String about negative $A and 0 for $B
  - FAIL: Destination templates have @use-when depending on static parameter values / Description-level static param $A and / independent scenario-level static param $B / Strings about negative $A and $B
...
- Stage: Run
- Error: XPST0003: mismatched input '<EOF>' expecting {'for', 'let', 'where', 'order', 'by', 'return', 'in', 'allowing', 'empty', 'at', 'stable', 'ascending', 'descending', 'greatest', 'least', 'collation', 'group', 'count', 'while', 'member', 'record', 'enum', 'tumbling', 'sliding', 'window', 'start', 'end', 'when', 'only', 'previous', 'next', 'current', 'if', 'then', 'else', 'some', 'every', 'satisfies', 'switch', 'case', KW_DEFAULT, 'typeswitch', 'try', 'catch', 'and', 'or', 'not', 'eq', 'ne', 'lt', 'le', 'gt', 'ge', 'is', 'div', 'idiv', 'mod', 'instance', 'of', 'treat', 'as', 'castable', 'cast', 'to', 'union', 'intersect', 'except', 'otherwise', 'insert', 'delete', 'replace', 'rename', 'copy', 'modify', 'into', 'with', 'nodes', 'value', 'before', 'after', 'first', 'last', 'contains', 'ftand', 'ftor', 'ftnot', 'phrase', 'any', 'all', 'word', 'words', 'distance', 'same', 'sentence', 'paragraph', 'entire', 'content', 'stemming', 'language', 'wildcards', 'sensitive', 'insensitive', 'diacritics', 'stop', 'thesaurus', 'using', 'no', 'item', 'node', 'element', 'attribute', 'text', 'comment', 'document-node', 'processing-instruction', 'schema-element', 'schema-attribute', 'namespace-node', 'empty-sequence', 'function', 'fn', 'child', 'descendant', 'self', 'descendant-or-self', 'following-sibling', 'following', 'parent', 'ancestor', 'preceding-sibling', 'preceding', 'ancestor-or-self', 'namespace', 'document', 'map', 'array', 'xquery', 'version', 'encoding', 'module', 'declare', 'variable', 'import', 'schema', 'external', 'option', 'construction', 'ordering', 'ordered', 'unordered', 'preserve', 'strip', 'boundary-space', 'copy-namespaces', 'no-preserve', 'inherit', 'no-inherit', 'base-uri', 'decimal-format', 'context', 'validate', 'strict', 'lax', 'type', URIQualifiedName, NCName}
...
- Stage: Run
- Error code: XPTY0004
- Error: Operands of node comparison operator must be nodes
...
- Stage: Run
- Error: Required parameter $tunnel-param-items not supplied

### `/repos/phoenixml/xspec/test/external_tutorial_global-context-item_original.xspec`

- Stage: Complete
- Passed: 0, Failed: 2, Pending: 0
  - FAIL: when no global context item is supplied / error code
...
- Stage: Run
- Error code: XPST0008
- Error: Variable $myp:param-2 not bound
...
- Stage: Run
- Error code: XPST0008
- Error: Variable $Q{urn:x-xspec:compile:impl}param-d190f2e1 not bound

### `/repos/phoenixml/xspec/test/external_tvt_stylesheet.xspec`

- Stage: Run
- Error code: XPST0008
- Error: Variable $Q{urn:x-xspec:compile:impl}param-d3ac24d6 not bound

### `/repos/phoenixml/xspec/test/external_undeclare-ns_stylesheet.xspec`

- Stage: Run
- Error code: XPTY0004
- Error: [file:///repos/phoenixml/xspec/test/external_undeclare-ns_stylesheet.xspec:7:11891] fn:in-scope-prefixes() requires an element node, got empty sequence

### `/repos/phoenixml/xspec/test/external_unfocused-param_inherited-by-focus.xspec`

- Stage: Run
- Error code: XPST0008
- Error: XPST0008: Variable $outer-scenario-param not defined
...
- Passed: 0, Failed: 5, Pending: 0
  - FAIL: Using URIQualifiedName in scenario-level global-param (@as | @name | @select) / should be possible
  - FAIL: Using URIQualifiedName in / global-param (@as | @name | @select) / should be possible
  - FAIL: Using URIQualifiedName in / context @mode and context template-param (@as | @name | @select) / should be possible
  - FAIL: Using URIQualifiedName in / context (@as | @select) / should be possible
  - FAIL: Using URIQualifiedName in / template-call @template and template-call template-param (@as | @name | @select) / should be possible
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_ws-only-text_stylesheet.xspec:48:18584] An axis step (Child::node()) was used when the context item is not a node (got item of type CrossStoreNodeRef)

### `/repos/phoenixml/xspec/test/external_x-context.xspec`

- Stage: Run
- Error: XPST0003: token recognition error at: '&'
...
- Stage: Complete
- Passed: 2, Failed: 3, Pending: 0
  - FAIL: In context template-param (i.e. //x:context/x:param), / @href is resolved with @xml:base
  - FAIL: In context (i.e. //x:context), / @href is resolved with @xml:base
  - FAIL: In template-call template-param (i.e. //x:call[@template]/x:param), / @href is resolved with @xml:base
...
- Stage: Run
- Error code: XTDE1400
- Error: XTDE1400: Invalid URI in xsl:result-document href: Invalid URI: The Authority/Host could not be parsed.

### `/repos/phoenixml/xspec/test/external_xsl-result-document_no-href.xspec`

- Stage: Complete
- Passed: 0, Failed: 1, Pending: 0
  - FAIL: Calling a template containing xsl:result-document[empty(@href)] / should be possible

### `/repos/phoenixml/xspec/test/external_xslt-package_arith.xspec`

- Stage: Run
- Error code: FOTY0013
- Error: FOTY0013: Atomization is not defined for maps
...
- Stage: Run
- Error code: XTDE3052
- Error: XTDE3052: Package 'http://example.org/complex-arithmetic.xsl' not found
...
- Stage: Run
- Error code: XTDE3052
- Error: XTDE3052: Package 'http://example.org/filter.xsl' not found
...
- Stage: Run
- Error: Required parameter $f not supplied
...
- Stage: Complete
- Passed: 0, Failed: 10, Pending: 0
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / Windows / Drive / Win32 (file:///C:/) / Upper-case drive letter / Discard everything before drive letter
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / Windows / Drive / Win32 (file:///C:/) / Lower-case drive letter / Discard everything before drive letter
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / Windows / Drive / Java (file:/C:/) / Upper-case drive letter / Discard everything before drive letter
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / Windows / Drive / Java (file:/C:/) / Lower-case drive letter / Discard everything before drive letter
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / Windows / UNC / Win32 (file://host/) / Discard file:
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / Windows / UNC / Java (file:////host/) / Discard file://
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / *nix / One slash / Discard file:
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / *nix / Two slashes / Discard file:
  - FAIL: Scenario for testing function format-uri / file: (%20 should be unescaped) / *nix / Three slashes / Discard file://
  - FAIL: Scenario for testing function format-uri / Non file: (Everything including %20 should be intact) / Intact
...
- Stage: Complete
- Passed: 3, Failed: 1, Pending: 0
  - FAIL: Without namespace nodes / xsl:sequence has no extra namespaces
...
- Stage: Run
- Error code: XTDE0540
- Error: XTDE0540: Multiple template rules match the node in a mode with on-multiple-match='fail'
...
- Stage: Complete
- Passed: 12, Failed: 4, Pending: 0
  - FAIL: Test x:UQName-of-step function / on step declaration / with colon in step type / returns URI-qualified name
  - FAIL: Test x:UQName-of-step function / on step declaration / without colon in step type / returns string value of @type
  - FAIL: Test x:UQName-of-step function / on XSpec call / with colon in step type / returns URI-qualified name
  - FAIL: Test x:UQName-of-step function / on XSpec call / without colon in step type / returns string value of @step
...
- Stage: Run
- Error code: XTTE0505
- Error: XTTE0505: Template match="PhoenixmlDb.Xslt.Ast.DotPattern" return value does not match declared type String: expected exactly one item, got 0
...
- Stage: Complete
- Passed: 0, Failed: 18, Pending: 0
  - FAIL: catch=yes with xsl:message[@terminate=yes] in xsl:function / [@as=xs:integer] / should catch err:XTMM9000
  - FAIL: catch=yes with xsl:message[@terminate=yes] in xsl:function / [@as=xs:integer] / should catch its message body
  - FAIL: catch=yes with xsl:message[@terminate=yes] in xsl:function / [@as=xs:integer] / verify xsl:function
  - FAIL: catch=yes with xsl:message[@terminate=yes] in xsl:function / [empty(@as)] / should catch err:XTMM9000
  - FAIL: catch=yes with xsl:message[@terminate=yes] in xsl:function / [empty(@as)] / should catch its message body
  - FAIL: catch=yes with xsl:message[@terminate=yes] in xsl:function / [empty(@as)] / verify xsl:function
  - FAIL: catch=yes with xsl:message[@terminate=yes] in calling xsl:template / [@as=xs:integer] / should catch err:XTMM9000
  - FAIL: catch=yes with xsl:message[@terminate=yes] in calling xsl:template / [@as=xs:integer] / should catch its message body
  - FAIL: catch=yes with xsl:message[@terminate=yes] in calling xsl:template / [@as=xs:integer] / verify xsl:template
  - FAIL: catch=yes with xsl:message[@terminate=yes] in calling xsl:template / [empty(@as)] / should catch err:XTMM9000
  - FAIL: catch=yes with xsl:message[@terminate=yes] in calling xsl:template / [empty(@as)] / should catch its message body
  - FAIL: catch=yes with xsl:message[@terminate=yes] in calling xsl:template / [empty(@as)] / verify xsl:template
  - FAIL: catch=yes with xsl:message[@terminate=yes] in matching xsl:template / [@as=xs:integer] / should catch err:XTMM9000
  - FAIL: catch=yes with xsl:message[@terminate=yes] in matching xsl:template / [@as=xs:integer] / should catch its message body
  - FAIL: catch=yes with xsl:message[@terminate=yes] in matching xsl:template / [@as=xs:integer] / verify xsl:template
  - FAIL: catch=yes with xsl:message[@terminate=yes] in matching xsl:template / [empty(@as)] / should catch err:XTMM9000
  - FAIL: catch=yes with xsl:message[@terminate=yes] in matching xsl:template / [empty(@as)] / should catch its message body
  - FAIL: catch=yes with xsl:message[@terminate=yes] in matching xsl:template / [empty(@as)] / verify xsl:template

### `/repos/phoenixml/xspec/test/issue-1135.xspec`

- Stage: Run
- Error code: XTSE0165
- Error: XTSE0165: Cannot find stylesheet module 'demo.xsl'
...
- Stage: Complete
- Passed: 0, Failed: 3, Pending: 0
  - FAIL: x:call/x:param/@name / should not affect global parameter
  - FAIL: x:context/x:param/@name / should not affect global parameter
  - FAIL: x:call[@template]/x:param/@name / should not affect global parameter
...
- Stage: Complete
- Passed: 1, Failed: 1, Pending: 0
  - FAIL: When converting heading element / With a child
...
- Stage: Complete
- Passed: 0, Failed: 1, Pending: 0
  - FAIL: Scenario-1 / Expect-1

### `/repos/phoenixml/xspec/test/issue-47.xspec`

- Stage: Complete
- Passed: 1, Failed: 7, Pending: 0
  ...
  - FAIL: Set context in *:foo / Inspect via a wrapper document node / One attribute exists
  ...
  - FAIL: wrap:wrap-nodes / Nodes are kept
...
- Passed: 2, Failed: 1, Pending: 0
  - FAIL: Use case from https://github.com/xspec/xspec/issues/59#issue-199577069
...
- Stage: Complete
- Passed: 0, Failed: 2, Pending: 0
  - FAIL: Aborts with abbreviation with no expansion / err:code
...
- Stage: Run
- Error code: XTSE0150
- Error: XTSE0150: A literal result element used as a simplified stylesheet module must have an xsl:version attribute
...
- Stage: Run
- Error code: FOTY0013
- Error: [file:///repos/phoenixml/xspec/test/non-node-context.xspec:4] [file:///tmp/phxspec-src-6432bf425b804560b4dc510967b6a04d/common/deep-equal.xsl:64] [file:///tmp/phxspec-src-6432bf425b804560b4dc510967b6a04d/common/deep-equal.xsl:158] Atomization is not defined for maps
  ↳ in expression (FunctionCallExpression): deep-equal($item1, $item2)
  ↳ in expression (QuantifiedExpression): every $i in (1 to count($seq1)) satisfies deq:item-deep-equal($seq1[$i], $seq2[$i], $flags)
  ↳ in expression (BinaryExpression): (not($result-type-mismatch) and deep-equal($expect-d2a32442, $result, ""))
...
- Passed: 3, Failed: 3, Pending: 0
  ...
  - FAIL: Using x: prefix in assertion / child node, @select and @test should work
...
- Stage: Complete
- Passed: 0, Failed: 5, Pending: 0
  - FAIL: Using x: prefix in / context @mode, template-param @name, @select, @as, and child node / should work
...
- Stage: Complete
- Passed: 0, Failed: 8, Pending: 0
  - FAIL: Imported file using different declarations on x:description / should reflect the imported file's xmlns:...
  - FAIL: Imported file using different declarations on x:description / and default element namespace.
  - FAIL: Imported file using different declarations on x:description / Imported file's xmlns:... should also be reflected in value of global param,
  - FAIL: Imported file using different declarations on x:description / global variable,
  - FAIL: Imported file using different declarations on x:description / and local variable.
  - FAIL: Imported file using different declarations on x:description / Imported file's default element namespace should also be reflected in value of global param,
  - FAIL: Imported file using different declarations on x:description / global variable,
  - FAIL: Imported file using different declarations on x:description / and local variable.
...
- Stage: Run
- Error code: XTTE0570
- Error: XTTE0570: Variable $local-name value does not match declared type String ExactlyOne

### `/repos/phoenixml/xspec/test/report-sequence_stylesheet_hof.xspec`

- Stage: Complete
- Passed: 0, Failed: 1, Pending: 0
  - FAIL: Scenario for testing function function-type / Function (excluding map and array) / function
...
- Stage: Complete
- Passed: 1, Failed: 16, Pending: 0
  - FAIL: templates / identity / copied, with significant text nodes wrapped in x:text
  - FAIL: parameters / no phase / xspec description
  - FAIL: parameters / with phase in user-content / xspec description
  - FAIL: parameters / with phase in @select / xspec description
  - FAIL: namespaces defined in Schematron / transformed
  - FAIL: scenario / nested / nested scenarios
  - FAIL: scenario / pending / pending scenarios
  - FAIL: scenario / focus / focused scenario
  - FAIL: scenario / shared / shared scenarios
  - FAIL: context / file / context href
  - FAIL: context / file with select / wrapper document node via wrap:wrap-nodes
  - FAIL: context / inline / wrapper document node
  - FAIL: context / inline with select / wrapper document node via wrap:wrap-nodes
  - FAIL: import / type schut (default) / resolve contents of imported file
  - FAIL: import / type xspec / resolve contents of imported file
  - FAIL: assertions / expect elements with correct label and test

### `/repos/phoenixml/xspec/test/select-node.xspec`

- Stage: Run
- Error: Could not find file '/repos/phoenixml/xspec/test/generate-node-selector.xsl'.

### `/repos/phoenixml/xspec/test/selection-from-doc-xproc.xspec`

- Stage: Run
- Error code: XTTE0570
- Error: XTTE0570: Variable $wrap-selected-nodes value does not match declared type String ExactlyOne
...
- Stage: Complete
- Passed: 10, Failed: 15, Pending: 0
  - FAIL: Tests for thd:rewrap-as-doc-node function / When input is a sequence of 3 wrapper elements with any names / the result is a sequence of 3 document nodes.
  - FAIL: Tests for thd:rewrap-as-doc-node function / When input is a sequence of 3 wrapper elements with any names / The 1st contains the children of document-wrapper1.
  - FAIL: Tests for thd:rewrap-as-doc-node function / When input is a sequence of 3 wrapper elements with any names / The 3rd contains the children of local:document-wrapper3.
  - FAIL: Tests for thd:rewrap-as-doc-node function / When wrapper element has namespace declarations / the result uses the declarations.
  - FAIL: Tests for thd:rewrap-as-doc-node function / When wrapper element enables text value templates / the result reflects TVT evaluation
  - FAIL: Tests for thd:rewrap-as-doc-node function / When wrapper element disables text value templates / the result does not reflect TVT evaluation
  - FAIL: Tests for thd:rewrap-as-doc-node function / When wrapper element has xml:base attribute / the result does *not* reflect the revised base URI
  - FAIL: Tests for thd:rewrap-as-doc-node function / When input is an empty sequence / the result is an empty sequence
  - FAIL: Tests for thd:wrap-each function / When input is a sequence of 4 nodes / the result is a sequence of 4 document nodes
  - FAIL: Tests for thd:wrap-each function / When input is a sequence of 4 nodes / respectively containing one element,
  - FAIL: Tests for thd:wrap-each function / When input is a sequence of 4 nodes / one processing instruction,
  - FAIL: Tests for thd:wrap-each function / When input is a sequence of text nodes / the result is a sequence of 2 document nodes
  - FAIL: Tests for thd:wrap-each function / When input is a sequence containing a node and an atomic value / followed by the atomic value unchanged
  - FAIL: Tests for thd:wrap-each function / When input is an empty sequence / the result is an empty sequence
  - FAIL: Tests for thd:wrapped-child-nodes-or-empty-document-node function / When input is one document-wrapper element / the result is a document node containing the children of document-wrapper.

### `/repos/phoenixml/xspec/test/test-utils.xspec`

- Stage: Run
- Error code: XTTE0570
- Error: XTTE0570: Variable $content-type-pattern value does not match declared type String ExactlyOne
...
- Stage: Complete
- Passed: 0, Failed: 2, Pending: 0
  - FAIL: Scenario with global static param, scenario-level static param,
			and scenario-level non-static param / Map of transform options includes A and B as static parameters
  - FAIL: Scenario with global static param, scenario-level static param,
			and scenario-level non-static param / and myp:default as non-static stylesheet parameter
...
- Stage: Complete
- Passed: 0, Failed: 3, Pending: 0
  - FAIL: Scenario for testing function left-trim / Leading trimmed. In-between and trailing intact.
  - FAIL: Scenario for testing function right-trim / Trailing trimmed. Leading and in-between intact.
  - FAIL: Scenario for testing function trim / Leading and trailing trimmed. In-between intact.

### `/repos/phoenixml/xspec/test/tunnel-param.xspec`

- Stage: Complete
- Passed: 0, Failed: 12, Pending: 0
  - FAIL: context template-param / with @tunnel enabled as / yes / takes effect.
  - FAIL: context template-param / with @tunnel enabled as / true / takes effect.
  - FAIL: context template-param / with @tunnel enabled as / 1 / takes effect.
  - FAIL: context template-param / with @tunnel disabled as / no / takes effect.
  - FAIL: context template-param / with @tunnel disabled as / false / takes effect.
  - FAIL: context template-param / with @tunnel disabled as / 0 / takes effect.
  - FAIL: template-call template-param / with @tunnel enabled as / yes / takes effect.
  - FAIL: template-call template-param / with @tunnel enabled as / true / takes effect.
  - FAIL: template-call template-param / with @tunnel enabled as / 1 / takes effect.
  - FAIL: template-call template-param / with @tunnel disabled as / no / takes effect.
  - FAIL: template-call template-param / with @tunnel disabled as / false / takes effect.
  - FAIL: template-call template-param / with @tunnel disabled as / 0 / takes effect.
...
- Stage: Compile
- Error code: XTDE0430
- Error: XTDE0430: Two namespace nodes with the same prefix '' have different namespace URIs ('http://docbook.org/ns/docbook' and 'http://www.w3.org/1999/xhtml')
...
- Passed: 4, Failed: 32, Pending: 0
  ...
  - FAIL: context template-param / user-content / @expand-text=yes on x:param / @expand-text=yes on x:* enables TVT for child text node
  ...
  - FAIL: context / user-content / @expand-text=yes on x:context / @expand-text=yes on x:* enables TVT for child text node
  - FAIL: context / user-content / @expand-text=yes on x:context / @expand-text=yes on x:* enables TVT for descendant text node
  - FAIL: context / @href / TVT is never enabled
  - FAIL: context / @href / @x:expand-text is kept
  - FAIL: context / @href / @expand-text is kept
  ...
  - FAIL: template-call template-param / user-content / @expand-text=yes on x:param / @expand-text=yes on x:* enables TVT for child text node
  ...
  - FAIL: global-param / user-content / @expand-text=yes on x:param / @expand-text=yes on x:* enables TVT for child text node
  - FAIL: global-param / user-content / @expand-text=yes on x:param / @expand-text=yes on x:* enables TVT for descendant text node
  - FAIL: global-param / @href / TVT is never enabled
  - FAIL: global-param / @href / @x:expand-text is kept
  - FAIL: global-param / @href / @expand-text is kept
...
- Stage: Run
- Error code: XPTY0004
- Error: [file:///repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec:7:12041] fn:in-scope-prefixes() requires an element node, got empty sequence
...
- Stage: Complete
- Passed: 0, Failed: 1, Pending: 0
  - FAIL: Outer scenario / Focused scenario / x:call should be inherited and modified
...
- Stage: Run
- Error code: XPST0008
- Error: Variable $ridiculous-uri not bound
...
- Stage: Run
- Error code: XPST0008
- Error: XPST0008: Variable $parent-name not defined
...
- Stage: Run
- Error code: XPST0008
- Error: Variable $myv:after_call not bound

### `/repos/phoenixml/xspec/test/version-utils.xspec`

- Stage: Run
- Error: Transformation terminated: ERROR in x:expect ('Scenario for testing variable saxon-version Assume we test this on Saxon versions from 11.7 to 13.x Greater than or equal to 11.7'): Non-boolean @test must be accompanied by @as, @href, @select, or child node.
...
- Stage: Run
- Error code: XPTY0004
- Error: An operand of the except operator is not a node
...
- Stage: Complete
- Passed: 11, Failed: 24, Pending: 0
  - FAIL: In context template-param, whitespace-only text nodes in user-content are removed by default. / So, in
				//x:context/x:param/element()[not(ancestor-or-self::element()/@xml:space)],
				whitespace-only text nodes are removed. / (verified via wrapper document)
  ...
  - FAIL: In context template-param, whitespace-only text nodes in user-content are removed by default. / But... / Text nodes created by x:text are intact. So, in
					//x:context/x:param/x:text[not(ancestor-or-self::element()/@xml:space)],
					whitespace-only text nodes are kept. / (verified via wrapper document)
  - FAIL: In context, whitespace-only text nodes in user-content are removed by default. / So, in //x:context/element()[namespace-uri() ne
  ...
  - FAIL: In template-call template-param, whitespace-only text nodes in user-content are removed by default. / So, in
  ...
  - FAIL: In global-param, whitespace-only text nodes in user-content are removed by default. / But... / Elements specified by @preserve-space are intact. So, in
					/x:description/x:param/element()[not(ancestor-or-self::element()/@xml:space)][node-name(.)
					= (for $qname in tokenize(/x:description/@preserve-space, '\s+') return
					resolve-QName($qname, /x:description))], / whitespace-only text nodes are kept.
...
- Stage: Run
- Error code: FORG0006
- Error: FORG0006: Effective boolean value not defined for a sequence of two or more items starting with a non-node value

### `/repos/phoenixml/xspec/test/xspec-name.xspec`

- Stage: Run
- Error code: XPTY0004
- Error: Lookup requires a map or array, got XdmText
