...
Of the 52 suites that ran to completion: 201 tests passed, 159 failed, 0 pending, out of 360 total. This excludes 122 skipped and 110 suites that did not reach completion — see below for both.

## Pick-list (by error code)

### Transformation terminated: ERROR: $Q{http://www.jenitennison.com/xslt/xspec}saxo… (39 suites)

- `/repos/phoenixml/xspec/test/external_as.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_default-mode-included-runas.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_default-mode-parent.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_global-context_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_global-override.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_helper.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_issue-1564.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_nested-context.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_param-position.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_scenario-param-static-use-when.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_transform.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_tunnel-param.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_tutorial_global-context-item_original.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_tutorial_under-the-hood_compilation-params-scope.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_tutorial_under-the-hood_compilation-sut_template.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_xsl-result-document_no-href.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/external_xslt-package_filter.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_xslt4.xspec` (stage: Run)

### XPTY0020 (21 suites)

- `/repos/phoenixml/xspec/test/avt-ws_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/avt_stylesheet.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/node-selection_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/prefix-conflict_local_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/prefix-conflict_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/prefix_parent-vs-import_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/select-node.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/tvt-ws_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/tvt_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/use-uqname_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/ws-only-text_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/xmlns-imported_stylesheet.xspec` (stage: Run)

### XPDY0002 (5 suites)

- `/repos/phoenixml/xspec/test/compile-xslt-tests.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/generate-pipeline.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/param-position-implicit-explicit.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/param-position-implicit-explicit_stylesheet.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/transform-options.xspec` (stage: Run)
...
### XTDE0555: No matching template found for node in mode with on-no-match='fail' (4 suites)
...
- `/repos/phoenixml/xspec/test/schut-to-xspec-compat.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/schut-to-xspec.xspec` (stage: Run)
...
### XPDY0002: Context item is absent (1 suite)
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/avt-ws_stylesheet.xspec:2:2318] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/avt_stylesheet.xspec:2:2321] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")
...
- Stage: Run
- Error code: XPDY0050
- Error: Required cardinality of value treated as String+ is one or more, but the sequence is empty
...
- Stage: Run
- Error code: XTTE0590
- Error: XTTE0590: Parameter $call requires type Element but got String

### `/repos/phoenixml/xspec/test/compile-xslt-tests.xspec`

- Stage: Run
- Error code: XPDY0002
- Error: Context item is absent
...
- Stage: Run
- Error: Transformation terminated: ERROR: $Q{http://www.jenitennison.com/xslt/xspec}saxon-config does not appear to be a Saxon configuration
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_avt-ws_stylesheet.xspec:2:2282] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<scenario-param-child xmlns:mirror="x-ur…")

### `/repos/phoenixml/xspec/test/external_avt_stylesheet.xspec`

- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_avt_stylesheet.xspec:2:2281] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_node-selection_stylesheet.xspec:2:1945] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_prefix-conflict_stylesheet.xspec:2:2184] An axis step (Child::element(x:global-param-child)) was used when the context item is not a node (got xs:string "<x:global-param-child xmlns:x="x-urn:tes…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_tvt-ws_stylesheet.xspec:5:166] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")

### `/repos/phoenixml/xspec/test/external_tvt_stylesheet.xspec`

- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_tvt_stylesheet.xspec:2:2754] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_use-uqname_stylesheet.xspec:5:3] An axis step (Child::element(global-param-child)) was used when the context item is not a node (got xs:string "<use-uqname:global-param-child xmlns:use…")

### `/repos/phoenixml/xspec/test/external_ws-only-text_stylesheet.xspec`

- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/external_ws-only-text_stylesheet.xspec:2:2121] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<span xmlns:mirror="x-urn:test:mirror" x…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/node-selection_stylesheet.xspec:2:1994] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")

### `/repos/phoenixml/xspec/test/non-node-context.xspec`

- Stage: Run
- Error code: FOTY0013
- Error: [file:///repos/phoenixml/xspec/test/non-node-context.xspec:4] [file:///tmp/phxspec-src-0058d8d7dfc74814a8e571f0dc3e1f36/common/deep-equal.xsl:64] [file:///tmp/phxspec-src-0058d8d7dfc74814a8e571f0dc3e1f36/common/deep-equal.xsl:158] Atomization is not defined for maps
  ...
  ↳ in expression (BinaryExpression): (not($result-type-mismatch) and deep-equal($expect-d3073dc3, $result, ""))
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/prefix-conflict_local_stylesheet.xspec:2:2246] An axis step (Child::element(x:global-param-child)) was used when the context item is not a node (got xs:string "<x:global-param-child xmlns:x="x-urn:tes…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/prefix-conflict_stylesheet.xspec:2:2242] An axis step (Child::element(x:global-param-child)) was used when the context item is not a node (got xs:string "<x:global-param-child xmlns:x="x-urn:tes…")

### `/repos/phoenixml/xspec/test/prefix_parent-vs-import_stylesheet.xspec`

- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/prefix_parent-vs-import_stylesheet.xspec:2:3575] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<tv1:element xmlns:tv1="http://example.o…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/src/schematron/select-node.xsl:29:31] An axis step (Attribute::prefix) was used when the context item is not a node (got xs:string "")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/tvt-ws_stylesheet.xspec:5:166] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/tvt_stylesheet.xspec:2:2796] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns:mirror="x-urn:…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec:2:2683] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<global-param-child xmlns="http://www.je…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/use-uqname_stylesheet.xspec:3:5] An axis step (Child::element(global-param-child)) was used when the context item is not a node (got xs:string "<use-uqname:global-param-child xmlns:use…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/ws-only-text_stylesheet.xspec:2:2170] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<span xmlns:mirror="x-urn:test:mirror" x…")
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/xmlns-imported_stylesheet.xspec:2:3564] An axis step (Child::node()) was used when the context item is not a node (got xs:string "<tv1:element xmlns:tv1="http://example.o…")
