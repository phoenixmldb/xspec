...
Of the 60 suites that ran to completion: 232 tests passed, 242 failed, 0 pending, out of 474 total. This excludes 122 skipped and 102 suites that did not reach completion — see below for both.
...
- Stage: Run
- Error code: FOTY0013
- Error: [file:///repos/phoenixml/xspec/test/non-node-context.xspec:4] [file:///tmp/phxspec-src-c0e87da71e104044b57fc473339cd068/common/deep-equal.xsl:64] [file:///tmp/phxspec-src-c0e87da71e104044b57fc473339cd068/common/deep-equal.xsl:158] Atomization is not defined for maps
  ...
  ↳ in expression (BinaryExpression): (not($result-type-mismatch) and deep-equal($expect-d143c380, $result, ""))
...
- Stage: Run
- Error code: XPTY0004
- Error: [file:///repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec:7:12045] fn:in-scope-prefixes() requires an element node, got empty sequence
