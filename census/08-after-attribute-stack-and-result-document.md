...
Of the 24 suites that ran to completion: 56 tests passed, 54 failed, 0 pending, out of 110 total. This excludes 122 skipped and 138 suites that did not reach completion — see below for both.

## Pick-list (by error code)

### FONS0004 (60 suites)

- `/repos/phoenixml/xspec/test/as_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/avt-ws_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/avt_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/compiler-eqname-utils.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/context-mode-ignored.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/context-param.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_as.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_as_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_avt-ws_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_avt_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_context-param.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_helper.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_issue-1564.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_issue-1564_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_nested-function-call.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_node-selection_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_non-node-context.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_param-position.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_pending-scenario-param-inherited-by-focus.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_prefix-conflict_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_template-context.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_transform.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_tunnel-param.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_tutorial_under-the-hood_compilation-params-scope.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_unfocused-param_inherited-by-focus.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_ws-only-text_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_xml-base_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_xslt-package_arith.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_xslt-package_arith_private.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_xslt-package_arith_use-1.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_xslt-package_filter.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/format-utils.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/get-step-declaration.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/helper_override.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/helper_xslt-package.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/issue-1564_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/issue-47.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/issue-746.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/node-selection_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/non-node-context.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/param-position-implicit-explicit.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/param-position-implicit-explicit_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/prefix-conflict_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/prefix_parent-vs-import_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/report-sequence_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/report-sequence_stylesheet_hof.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/report-sequence_stylesheet_schema-aware.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/schut-to-xslt.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/select-node.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/template-context.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/test-helper-documents.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/tunnel-param.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/unfocused-context.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/unfocused-template-call.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/variable_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/wrap_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/ws-only-text_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/xml-base_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/xmlns-imported_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/xspec-uri_stylesheet.xspec` (stage: Compile)

### XTDE1260 (27 suites)

- `/repos/phoenixml/xspec/test/catch_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_catch_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_global-context_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_issue-1020_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_multiple-context-items.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_multiple-context-items_function.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_pending-scenario-shared-param-inherited-by-focus.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_scenario-param.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_tvt-ws_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_tvt_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_unfocused-shared-param_inherited-by-focus.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_unfocused-shared-param_not-inherited-by-focus.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_x-context.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_xmlns.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/generate-node-selector.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/issue-1020_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/issue-1029.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/multiple-context-items.xspec` (stage: Compile)
...
- `/repos/phoenixml/xspec/test/tvt-ws_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/tvt_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/variable-like_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/x-context.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/xmlns_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/xsl-result-document.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/xspec-name.xspec` (stage: Compile)

### Transformation terminated: ERROR: $Q{http://www.jenitennison.com/xslt/xspec}saxo… (12 suites)
...
### FORX0002: Invalid regular expression: POSIX character class syntax '[:' is not s… (11 suites)

- `/repos/phoenixml/xspec/test/compile-xproc-tests.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/compile-xslt-tests.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/compiler-sequencetype-with-uqnames.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/external_no-prefix_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_undeclare-ns_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/external_use-uqname_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/generate-test-case-step.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/generate-xproc-imports.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/no-prefix_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec` (stage: Compile)
- `/repos/phoenixml/xspec/test/use-uqname_stylesheet.xspec` (stage: Compile)

### XTSE0280 (5 suites)

- `/repos/phoenixml/xspec/test/issue-538.xspec` (stage: Run)
...
- `/repos/phoenixml/xspec/test/issue-23_1.xspec` (stage: Run)
- `/repos/phoenixml/xspec/test/nested-context.xspec` (stage: Run)
...
### XPST0003: mismatched input '<EOF>' expecting {'for', 'let', 'where', 'order', 'b… (1 suite)

- `/repos/phoenixml/xspec/test/external_unfocused-param_not-inherited-by-focus.xspec` (stage: Run)

### XPST0081 (1 suite)

- `/repos/phoenixml/xspec/test/user-content-utils.xspec` (stage: Run)

### XPTY0004 (1 suite)

- `/repos/phoenixml/xspec/test/issue-59_use-case-1.xspec` (stage: Run)
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'mirror' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: XTDE1260
- Error: XTDE1260: No xsl:key declaration found with name 'local:scenarios'
...
- Stage: Compile
- Error: FORX0002: Invalid regular expression: POSIX character class syntax '[:' is not supported in XSD regex
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'local' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'my' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'issue-1564' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'nested-function-call' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'param-position' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'x' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'transform' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'f' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'xsl' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'fmt' is not declared in the in-scope namespaces
...
- Stage: Run
- Error code: XTTE0505
- Error: XTTE0505: Template match="@Attribute()" return value does not match declared type Node: expected exactly one item, got 0
...
- Stage: Run
- Error code: XTTE0505
- Error: XTTE0505: Template 'identity' return value does not match declared type Node: expected exactly one item, got 0
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'wrap' is not declared in the in-scope namespaces

### `/repos/phoenixml/xspec/test/issue-538.xspec`

- Stage: Run
- Error code: XTSE0280
- Error: XTSE0280: Namespace prefix 'map' in QName 'map:merge' is not declared
...
- Stage: Run
- Error code: XTSE0280
- Error: XTSE0280: Namespace prefix 'items' in QName 'items:comment' is not declared

### `/repos/phoenixml/xspec/test/issue-59_use-case-1.xspec`

- Stage: Run
- Error code: XPTY0004
- Error: fn:QName first argument must be a string, got XsAnyUri
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'mf' is not declared in the in-scope namespaces
...
- Stage: Run
- Error code: XPTY0020
- Error: [file:///repos/phoenixml/xspec/test/prefix-conflict_local_stylesheet.xspec:2:2248] An axis step (Child::element(x:global-param-child)) was used when the context item is not a node (got xs:string "<x:global-param-child xmlns:x="x-urn:tes…")
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'q1' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'rep' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'sn' is not declared in the in-scope namespaces
...
- Stage: Compile
- Error code: FONS0004
- Error: Prefix 'thd' is not declared in the in-scope namespaces
...
- Stage: Run
- Error code: XTSE0280
- Error: XTSE0280: Namespace prefix 'test-helper' in QName 'test-helper:remove-whitespace-only-text' is not declared
...
- Stage: Run
- Error code: XTSE0280
- Error: XTSE0280: Namespace prefix 'myv' in QName 'myv:uri-with-private-scheme' is not declared
...
- Stage: Run
- Error code: XPST0081
- Error: XPST0081: Namespace prefix 'p' has not been declared
