...
- Stage: Run
- Error code: FOTY0013
- Error: [file:///repos/phoenixml/xspec/test/non-node-context.xspec:4] [file:///tmp/phxspec-src-5be40eabf4834fd7b7b0b0971aebde9b/common/deep-equal.xsl:64] [file:///tmp/phxspec-src-5be40eabf4834fd7b7b0b0971aebde9b/common/deep-equal.xsl:158] Atomization is not defined for maps
  ...
  ↳ in expression (BinaryExpression): (not($result-type-mismatch) and deep-equal($expect-d1903fce, $result, ""))
...
- Stage: Run
- Error code: XTTE0505
- Error: XTTE0505: Template match="expect-assert" return value does not match declared type Text: expected exactly one item, got 2
...
- Stage: Run
- Error code: XPTY0004
- Error: [file:///repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec:7:12048] fn:in-scope-prefixes() requires an element node, got empty sequence
