...
Of the 62 suites that ran to completion: 233 tests passed, 259 failed, 0 pending, out of 492 total. This excludes 122 skipped and 100 suites that did not reach completion — see below for both.

## Pick-list (by error code)

### Transformation terminated: ERROR: $Q{http://www.jenitennison.com/xslt/xspec}saxo… (47 suites)
...
- Stage: Run
- Error code: FOTY0013
- Error: [file:///repos/phoenixml/xspec/test/non-node-context.xspec:4] [file:///tmp/phxspec-src-63e9a9b9eff04e64995b2a0641029764/common/deep-equal.xsl:64] [file:///tmp/phxspec-src-63e9a9b9eff04e64995b2a0641029764/common/deep-equal.xsl:158] Atomization is not defined for maps
  ...
  ↳ in expression (BinaryExpression): (not($result-type-mismatch) and deep-equal($expect-d1b4156f, $result, ""))
...
- Stage: Run
- Error code: XPTY0004
- Error: [file:///repos/phoenixml/xspec/test/undeclare-ns_stylesheet.xspec:7:12046] fn:in-scope-prefixes() requires an element node, got empty sequence
